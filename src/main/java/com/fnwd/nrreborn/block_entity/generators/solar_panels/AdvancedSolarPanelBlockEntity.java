...
public class AdvancedSolarPanelBlockEntity extends AbstractGeneratorBlockEntity {
    public AdvancedSolarPanelBlockEntity(BlockPos pos, BlockState blockState) {
        super(NRRBlockEntities.ADVANCED_SOLAR_PANEL_BLOCK_ENTITY.get(), pos, blockState, 12000);
    }
