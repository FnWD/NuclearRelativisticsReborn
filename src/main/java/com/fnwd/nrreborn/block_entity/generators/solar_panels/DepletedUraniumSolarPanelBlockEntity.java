...
public class DepletedUraniumSolarPanelBlockEntity extends AbstractGeneratorBlockEntity {
    public DepletedUraniumSolarPanelBlockEntity(BlockPos pos, BlockState blockState) {
        super(NRRBlockEntities.DEPLETED_URANIUM_SOLAR_PANEL_BLOCK_ENTITY.get(), pos, blockState, 48000);
    }
