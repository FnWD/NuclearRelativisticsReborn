...
public class BasicSolarPanelBlockEntity extends AbstractGeneratorBlockEntity {
    public BasicSolarPanelBlockEntity(BlockPos pos, BlockState blockState) {
        super(NRRBlockEntities.BASIC_SOLAR_PANEL_BLOCK_ENTITY.get(), pos, blockState, 3000);
    }
